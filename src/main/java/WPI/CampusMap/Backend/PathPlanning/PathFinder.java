...
public class PathFinder {
	 ...
	 * @param processor
	 *            The path processor to use for processing the path finding.
	 * @return The path between all destinations
	 * @throws PathNotFoundException
	 *             Thrown when no path can be found.
	 * @throws NotEnoughPointsException
	 *             Thrown when not enough points are provided {0,1}
	 */
	public static Path getPath(IPoint[] destinations, PathProcessor processor)
			throws PathNotFoundException, NotEnoughPointsException {
	 ...
	 *             Thrown when not enough points are provided {0,1}
	 */
	public static Path getPath(IPoint a, IPoint b, PathProcessor processor)
			throws PathNotFoundException, NotEnoughPointsException {
